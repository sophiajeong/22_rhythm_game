...
# pygame.mixer.music.load("노래이름.mp3")
# pygame.mixer.music.play(0)
#======== 함수 ===============================
#키 이벤트 처리하기
def resultProcess(direction):
    global isColl, score, DrawResult, result_ticks, level, n
...
def eventProcess(): # 눌려진 키의 이벤트를 가져와서
    global isActive, score, start_time, level
...
class Direction(object):
    ...
    def draw(self):
        ...
        if self.y >= SCREEN_HEIGHT:
            ...
            self.y += n   # 위의 경우가 전부 아닌 경우 y가 1씩 증가하며 이미지가 그려진다.
